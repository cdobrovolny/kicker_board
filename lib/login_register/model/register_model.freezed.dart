...
abstract class $RegisterModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({Credentials credentials, String username});
...
class _$_RegisterModel implements _RegisterModel {
  const _$_RegisterModel({required this.credentials, required this.username});
  ...
  @override
  String toString() {
    return 'RegisterModel(credentials: $credentials, username: $username)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, credentials, username);
...
abstract class _RegisterModel implements RegisterModel {
  const factory _RegisterModel(
      ...
      required final String username}) = _$_RegisterModel;
